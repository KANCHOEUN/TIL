...
1. 이원 탐색 트리의 노드는 다음과 같은 순서로 추가된다. (O)
2. 중위 순회를 수행하여 노드의 second값을 출력한다. (O)
3. 노드 4를 삭제한다. (O)
4. 중위 순회를 수행하여 노드의 seocnd값을 출력한다. (O)
5. 노드 5를 삭제한다. (O)
6. 중위 순회를 수행하여 노드의 second값을 출력한다. (O)
7. 노드 2를 삭제한다. (O)
8. 중위 순회를 수행하여 노드의 second값을 출력한다. (O)
9. 노드 2가 있는지 확인하여 second 결과를 출력한다. (O)
10. 노드 9가 있는지 확인하여 second 결과를 출력한다. (O)
